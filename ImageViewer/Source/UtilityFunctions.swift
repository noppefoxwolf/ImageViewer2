...
func aspectFitSize(forContentOfSize contentSize: CGSize, inBounds bounds: CGSize) -> CGSize {
  ...
  return AVMakeRect(
    aspectRatio: contentSize, insideRect: CGRect(origin: CGPoint.zero, size: bounds)
  ).size
}
...
func aspectFitContentSize(forBoundingSize boundingSize: CGSize, contentSize: CGSize) -> CGSize {
  ...
  return AVMakeRect(
    aspectRatio: contentSize, insideRect: CGRect(origin: CGPoint.zero, size: boundingSize)
  ).size
}
...
func contentCenter(forBoundingSize boundingSize: CGSize, contentSize: CGSize) -> CGPoint {
  ...
  return CGPoint(
    x: contentSize.width * 0.5 + horizontalOffset, y: contentSize.height * 0.5 + verticalOffset)
}
