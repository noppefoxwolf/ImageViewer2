    ...
    UINavigationBarDelegate
{
    ...
    @objc func rotate() {
        ...
        UIView.animate(
            withDuration: rotationAnimationDuration,
            delay: 0,
    ...
    override func viewDidLoad() {
        ...
        self.collectionView?
            .register(ThumbnailCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    private func addCloseButton() {
        ...
        case .pinRight(let marginTop, let marginRight):
            ...
            closeButton.frame.origin.x =
                self.view.bounds.size.width - marginRight - closeButton.bounds.size.width
