...
class BlurView: UIView {
    ...
    func present() {
        ...
        UIView.animate(
            withDuration: configuration.blurPresentDuration,
            delay: configuration.blurPresentDelay,
            options: .curveLinear,
        ...
        UIView.animate(
            withDuration: configuration.colorPresentDuration,
            delay: configuration.colorPresentDelay,
            options: .curveLinear,
            animations: { [weak self] in
                guard let self else { return }
    ...
    func dismiss() {
        ...
        UIView.animate(
            withDuration: configuration.blurDismissDuration,
            delay: configuration.blurDismissDelay,
            options: .curveLinear,
            animations: { [weak self] in
        ...
        UIView.animate(
            withDuration: configuration.colorDismissDuration,
            delay: configuration.colorDismissDelay,
            options: .curveLinear,
            animations: { [weak self] in
