...
final class GallerySwipeToDismissTransition {
    ...
    func updateInteractiveTransition(
        horizontalOffset hOffset: CGFloat = 0,
        verticalOffset vOffset: CGFloat = 0
    ) {
    ...
    func finishInteractiveTransition(
        _ swipeDirection: SwipeToDismiss,
        touchPoint: CGFloat,
        ...
        UIView.animate(
            withDuration: expectedDuration * 0.65,
            delay: 0,
            ...
            animations: { [weak self] () -> Void in
                ...
                case .horizontal:
                    self?.scrollView?
                        .setContentOffset(CGPoint(x: targetOffset, y: 0), animated: false)
                case .vertical:
                    self?.scrollView?
